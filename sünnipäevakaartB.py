...
def kingitus_õnnesoovidega():
    tahvel.create_rectangle(81,180,310 ,360,width=2,fill="red",outline="black")
    tahvel.create_line(186 ,170,188 ,367,width=2,fill="yellow")
    tahvel.create_line(85 ,260,308 ,254,width=2,fill="yellow")
def kõik_korraga():
    õhupallid = 0
    kook_küünlatega = 0
    liigub = 0
